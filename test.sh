...
read db_table
echo "ok i will create a table named $db_table if he does'nt exists"
...
master_con1="'"
master_con='export MYSQL_PWD=Babina_; mysql -u root -h 127.0.0.1 -pBabina_ mydb -e "create table if not exists '$db_table'('$field1' '$db_type', '$field2' '$db_type', '$field3' '$db_type', '$field4' '$db_type', '$field5' '$db_type', '$field6' '$db_type'); '$insert' ;"'
